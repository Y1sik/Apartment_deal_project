  ...
  <nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
      ...
      <li
        ...
        v-bind:class="{
          active:
            startPageIndex + index - 1 == $store.state.review.currentPageIndex,
        }"
        class="page-item"
      >
        <a
...
export default {
  ...
  computed: {
    pageCount: function () {
      return this.$store.getters.getReviewPageCount;
    },
    startPageIndex: function () {
      return this.$store.getters.getStartReviewPageIndex;
    },
    endPageIndex: function () {
      return this.$store.getters.getReviewEndPageIndex;
    },
    prev: function () {
      return this.$store.getters.getReviewPrev;
    },
    next: function () {
      return this.$store.getters.getReviewNext;
    },
  },
  methods: {
    // 부모에게 event 전달
