  ...
  <nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
      ...
      <li
        ...
        v-bind:class="{
          active:
            startPageIndex + index - 1 == $store.state.free.currentPageIndex,
        }"
        class="page-item"
      >
        <a
...
export default {
  ...
  computed: {
    pageCount: function () {
      return this.$store.getters.getFreePageCount;
    },
    startPageIndex: function () {
      return this.$store.getters.getStartFreePageIndex;
    },
    endPageIndex: function () {
      return this.$store.getters.getFreeEndPageIndex;
    },
    prev: function () {
